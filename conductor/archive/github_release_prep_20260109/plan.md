...
- [x] Task: Generate Release Artifact
    - [x] Run `python scripts/recombine.py` to ensure `opencode_agent_release.py` is fresh.
...
- [x] Task: Create Release via CLI
    - [x] Run `gh release create <version> opencode_agent_release.py -F RELEASE_NOTES.md --title "<Version> - <Title>"`

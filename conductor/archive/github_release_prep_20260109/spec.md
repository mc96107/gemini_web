...
- **Artifact Generation:** Ensure `opencode_agent_release.py` is up-to-date by running `scripts/recombine.py`.
...
- [ ] The release includes `opencode_agent_release.py` as an asset.
